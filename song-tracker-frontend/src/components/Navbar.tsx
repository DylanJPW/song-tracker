...
export function Navbar() {
  ...
  return (
    <div
      className="sticky top-0 z-10 flex w-auto flex-col items-start gap-x-4 border-b border-b-black p-4 font-bold md:flex-row md:items-center md:justify-between dark:bg-gray-900">
